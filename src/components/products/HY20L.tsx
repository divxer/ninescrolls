  ...
  return (
    <>
      ...
      <section className="product-comparison-section">
        <div className="container">
          <h2 className="section-title">Choose HY-20L if you:</h2>
          <div className="comparison-choice-grid">
            ...
            <div className="choice-item">
              ...
              <p>Automated operation and process reproducibility make HY-20L ideal for transitioning from exploratory research to routine processing.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="product-features-section product-benefits-section">
        <div className="container">
          <h2 className="section-title">Why HY-20L</h2>
