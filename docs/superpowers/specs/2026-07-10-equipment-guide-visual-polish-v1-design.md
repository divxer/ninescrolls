...
- The visual-iteration loop MUST confirm the `min-height` produces **no extra blank pages**; if any product page overflows to a second page, reduce `min-height` until the guide is exactly 14 pages again.
