...
```
(Self-gating AND status-preserving — fails on new `error TS` lines outside `main.tsx` OR on an abnormal tsc exit whose output lacks the known `main.tsx` diagnostic. Same form as Part 1 Task 15.)
