...
const outputPath = process.argv[3] ?? 'tmp/cryo-cover/cryo-buyers-guide-cover-v2.png';

if (!inputPath) {
  throw new Error('Usage: node scripts/generate-cryo-buyers-guide-cover.mjs <scene.png> [output.png]');
}
